    ...
    return (
        <section className="">
            <div className="flex flex-col items-center justify-center sm:max-w-md px-6 py-8 mx-auto md:h-screen lg:py-0">
                <div className="w-full bg-white rounded-lg shadow shadow-cyan-500/50 dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                    <div className="p-6 space-y-2 md:space-y-4 sm:p-8">
                        ...
                        <div className="flex flex-col gap-2">
                            <button className="flex w-full items-center justify-center bg-[#FF808A] h-12 rounded-lg">
                                Send OTP
                            </button>
